...
由於 Blender 4.0 之後推行了新的擴充功能（Extensions）架構，安裝包根據版本分為兩種，請依據您的 Blender 版本選擇下載：

| 壓縮檔名稱 | 支援 Blender 版本 | 說明 |
| :--- | :--- | :--- |
| **`NLA_stride_vX.X.X.zip`** | **3.0 ~ 5.x+** | 傳統外掛格式，相容性廣 |
| **`nla_stride-X.X.X.zip`** | **4.0 以上** | 採 4.0+ 新式打包規範 ( 官方建議 ) |
